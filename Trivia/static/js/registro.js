document.addEventListener("DOMContentLoaded", () => {
    ...
    formulario.addEventListener("submit", function (e) {
        const esUsuarioValido = validarUsuario(usuarioInput.value.trim());
        const esEmailValido = validarEmail(emailInput.value.trim());
        const esPasswordValido = validarPassword(passwordInput.value.trim());
        const esGeneroValido = validarGenero(generoInput.value);
        const esTerminosValido = validarTerminos(terminosInput.checked);
