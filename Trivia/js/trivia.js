...
function mostrarResultado() {
    ...
    // cambio a icono de medalla
    document.getElementById("reloj-icono").src = "assets/img/medalla.gif";
    // oculto reloj de la pantalla de resultados
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    btnCerrarSesion.addEventListener("click", () => {
        window.location.href = "./login.html";// lo lleva de nuevo a iniciar sesion
    });
});
...
function reiniciarJuego() {
    ...
    document.getElementById("reloj-icono").src = "assets/img/reloj.gif";
